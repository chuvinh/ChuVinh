	...
	<div class="containt">
		...
		<div class="menu_tab_content">
			<ul class="nav nav-tabs">
			 	<li class="active"><a data-toggle="tab" href="#dstaikhoan">Danh sách tài khoản</a></li>
			 	<li><a data-toggle="tab" href="#themtaikhoan">Thêm tài khoản</a></li>
			 	<li><a data-toggle="tab" href="#xoataikhoan">Xóa tài khoản</a></li>
			 	<li><a data-toggle="tab" href="#suataikhoan">Sửa tài khoản</a></li>
			</ul>
			<div class="tab-content">
			 	<div id="dstaikhoan" class="tab-pane fade in active">
					<div class="col-md-12">
						<table class="table">
							<tr>
								<th>STT</th>
			 	...
			 	<div id="suataikhoan" class="tab-pane fade">
			 		<div class="col-md-12">
						<table class="table">
							<tr>
								<th></th>
					...
					<div class="btnsuatb">
						<a href="admin_suataikhoan.jsp"><button class="btn btn-info" type="button" id="btnShowModal_suatk">Sửa tài khoản</button></a>
					</div>
			 	</div>
