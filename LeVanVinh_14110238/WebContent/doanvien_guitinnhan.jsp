		...
		<nav class="navbar navbar-inverse">
			<div class="container-fluid">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="selecttinnhan?mssv=<%=mssv%>">Tin
							nhắn</a></li>
						...
						<form method="post" action="cbdkguitn?manhan=<%=mssv%>">
							<div class="form-group">
								<label>Người nhận:</label> <input type="text"
									class="form-control"  name="magui" required
									placeholder="To" value="<%=mangnhan%>">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea rows="5" cols="50" required
									name="noidung" class="form-control" placeholder="Enter Content"></textarea>
							</div>
