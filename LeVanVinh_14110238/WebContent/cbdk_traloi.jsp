...
<body>
	<div class="containt">
		...
		<% String mangnhan=request.getParameter("magui"); %>
		<div class="menu_tab_content">
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#guitinnhan">Gửi
						tin nhắn</a></li>
			</ul>
			<div id="guitinnhan" class="tab-pane fade in active">
				<div class="col-md-8">
					<form method="post" action="cbdktraloi?manhan=<%=mssv%>">
						<div class="form-group">
							<label>Người nhận:</label> <input type="text"
								class="form-control" name="magui" value="<%= mangnhan %>"
								placeholder="To" readonly="readonly" required>
						</div>
						<div class="form-group">
							<label>Tiêu đề:</label> <input type="text" class="form-control"
								name="tieude" placeholder="Enter Subject" required>
						</div>
						<div class="form-group">
							<label>Nội dung:</label>
							<textarea rows="5" cols="50" required name="noidung" class="form-control"
