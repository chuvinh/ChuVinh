...
<body>
	<div class="containt">
		...
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="selectdoanvien?mssv=<%=mssv%>">Tra
						cứu</a></li>
	...
	<div class="menu_tab_content">
		...
		<a href="sua?mssv=<%=rs.getString("MSSV")%>"><button
				class="btn btn-info">Chỉnh Sửa</button></a> <a
			href="selectdoanvien?mssv=<%=rs.getString("MSSV")%>"><button
