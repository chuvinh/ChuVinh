		...
		<div class="menu_tab_content">
			...
			<div class="tab-content">
			 	<div id="dshoatdong" class="tab-pane fade in active">
					<div class="col-md-12">
						Tên hoạt động: Vệ sinh trường<br>
						Đơn vị tổ chức: ĐHSPKT<br>
						Ngày bắt đầu: 20/10/2016<br>
						Ngày kết thúc: 25/10/2016<br>
						Số lượng: 60<br>
						Điểm RL: 5<br>
						Điểm CTXH: 10<br>
						Nội dung: Vệ sinh các khu của trường<br>
						<div class="btnduyethoatdong">
							<button class="btn btn-info" type="button" id="btnShowModal_duyethoatdong">Duyệt hoạt động</button>
						</div>
					</div>
			 	</div>
