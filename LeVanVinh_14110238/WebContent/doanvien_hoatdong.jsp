				...
				<div id="dshoatdong" class="tab-pane fade in active">
					...
					<table class="table">
						...
						<tr>
							...
							<td><a
								href="xemchitiethd?mahd=<%=rs.getString("MaHD")%>&mssv=<%=mssv%>"><button class="btn btn-info" type="button">Xem
					...
					<a href="selecthddk?mssv=<%=mssv%>"><button type="submit"
								class="btn btn-info">Hoạt động đã đăng ký</button></a>
				</div>
			</div>
		</div>
	</div>
