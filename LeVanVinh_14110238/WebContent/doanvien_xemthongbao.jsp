	...
	<div class="containt">
		...
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="selectthongbao">Thông báo</a></li>
		...
		<div class="xemthongbao" style="margin: 10px 0 0 10px;">
			<%
				...
				while(rs.next()){
			%>
			<a href="xemchitiettb?matb=<%= rs.getString("MaTB")%>"><%= rs.getString("MaTB")%>. <%= rs.getString("TieuDe") %></a><br>
			<% } %>
		</div>
	</div>
	<div class="footer">
