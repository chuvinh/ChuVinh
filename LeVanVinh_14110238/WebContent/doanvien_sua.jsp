	...
	<div class="containt">
		...
		<div class="container-fluid">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="selectdoanvien?mssv=<%= mssv %>">Tra cứu</a></li>>
			...
			<div class="tab-content">
				<form role="form" id="contactform"
					...
					<div class="col-md-6">
						...
						<tr>
							...
							<td><input type="text" class="form-control" name="mssv"
								placeholder="Enter MSSV" readonly="readonly" required
								value="<%=rs.getString("MSSV")%>"></td>
						</tr>
						<tr>
							<td><label>Mật khẩu:</label></td>
							<td><input type="password" class="form-control"
								name="password" placeholder="Enter MSSV" required
								value="<%=rs.getString("Pass")%>"></td>
						</tr>
						<tr>
							<td><label>Mã chi đoàn:</label></td>
							<td><input type="text" class="form-control" name="tencd" required
								placeholder="Enter MSSV" value="<%=rs.getString("MaCD")%>"></td>
						</tr>
						<tr>
							<td><label>Tên đoàn viên:</label></td>
							<td><input type="text" class="form-control" name="tendv" required
								placeholder="Enter Name" value="<%=rs.getString("Ten")%>"></td>
						</tr>
						<tr>
							<td><label>Ngày sinh:</label></td>
							<td><input type="text" class="form-control" name="ngaysinh"
								placeholder="Enter BirthDay" required
								value="<%=rs.getString("NgaySinh")%>"></td>
						</tr>
						<tr>
							<td><label>Email:</label></td>
							<td><input type="text" class="form-control" name="email" required
								placeholder="Enter Email" value="<%=rs.getString("Email")%>"></td>
						</tr>
						<tr>
							<td><label>SĐT:</label></td>
							<td><input type="text" class="form-control" name="sdt"
								placeholder="Enter Phone Number" required
								value="<%=rs.getString("Sdt")%>"></td>
							<br>
						</tr>
					</div>
					<div class="col-md-6">
						<tr>
							...
							<td><input type="text" class="form-control" required
								...
								value="<%=rs.getString("NgayVaoDoan")%>"></td>
						</tr>
						<tr>
							<td><label>Giới tính:</label></td>
							<td><input type="text" class="form-control" name="gioitinh" required
								placeholder="Enter Sex" value="<%=rs.getString("GioiTinh")%>"></td>
						</tr>
						<tr>
							<td><label>CMND: </label></td>
							<td><input type="text" class="form-control" name="cmnd" required
								placeholder="Enter CMND" value="<%=rs.getString("CMND")%>"></td>
						</tr>
						<tr>
							<td><label>Quê quán:</label></td>
							<td><input type="text" class="form-control" name="quequan" required
								placeholder="Enter QueQuan" value="<%=rs.getString("QueQuan")%>"></td>
						</tr>
						<tr>
							<td><label>Tôn giáo: </label></td>
							<td><input type="text" class="form-control" name="tongiao" required
								placeholder="Enter TonGiao" value="<%=rs.getString("TonGiao")%>"></td>
						</tr>
						<tr>
							<td><label>Dân tộc: </label></td>
							<td><input type="text" class="form-control" name="dantoc" required
								placeholder="Enter DanToc" value="<%=rs.getString("DanToc")%>"></td>
						</tr>
						<tr>
							<td><label>Địa chỉ: </label></td>
							<td><input type="text" class="form-control" name="diachi" required
								placeholder="Enter Address" value="<%=rs.getString("DiaChi")%>"></td>
							<br>
						</tr>
					</div>
					...
					<button class="btn btn-info" type="submit" name="sua">Sửa
						người dùng</button>
					<a href="selectdoanvien?mssv=<%=rs.getString("MSSV")%>"><button
