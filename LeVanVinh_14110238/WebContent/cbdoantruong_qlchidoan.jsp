	...
	<div class="containt">
		...
		<nav class="navbar navbar-inverse">
		    <div class="container-fluid">
		        <ul class="nav navbar-nav">
		          <li><a href="cbdoantruong_login.jsp">Trang chủ</a></li>
		...
		<div class="menu_tab_content">
			<ul class="nav nav-tabs">
			 	<li class="active"><a data-toggle="tab" href="#dschidoan">Danh sách chi đoàn</a></li>
			 	<li><a data-toggle="tab" href="#themchidoan">Thêm chi đoàn</a></li>
			 	<li><a data-toggle="tab" href="#xoachidoan">Xóa chi đoàn</a></li>
			 	<li><a data-toggle="tab" href="#suachidoan">Sửa chi đoàn</a></li>
			</ul>
			<div class="tab-content">
			 	...
			 	<div id="suachidoan" class="tab-pane fade">
			 		<div class="col-md-12">
						<table class="table">
							<tr>
								<th></th>
					...
					<div class="btnsuatb">
						<a href="cbdoantruong_suachidoan.jsp"><button class="btn btn-info" type="button" id="btnShowModal_suacd">Sửa chi đoàn</button></a>
					</div>
			 	</div>
			</div>
		</div>
