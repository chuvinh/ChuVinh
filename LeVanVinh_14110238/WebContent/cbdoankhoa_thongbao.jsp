...
<body>
	...
	<div class="menu_tab_content">
		<ul class="nav nav-tabs">
			<li class="active"><a data-toggle="tab" href="#dsthongbao">Danh
					sách thông báo</a></li>
		...
		<div class="tab-content">
			<div id="dsthongbao" class="tab-pane fade in active">
				<div class="col-md-12">
					<table class="table">
						...
						<%
							ResultSet rs = (ResultSet) request.getAttribute("listtb");
							while (rs.next()) {
						%>
						<tr>
							<td><%=rs.getString("TieuDe")%></td>
							<td><%=rs.getString("NoiDung")%></td>
							<td><a href="#"><button class="btn btn-info" type="button">Sửa</button></a> <a href="xoathongbao?matb=<%=rs.getString("MaTB")%>"><button class="btn btn-info" type="button">Xóa</button></a></td>
						</tr>
						<%
							}
						%>
			...
			<div id="themthongbao" class="tab-pane fade">
				<div class="col-md-8">
					<form method="post" action="themthongbao">
						<div class="form-group">
							<label>Tiêu đề:</label> <input type="text" class="form-control" required
								id="t_trichdoan" name="tieude" placeholder="Nhập vào tiêu đề">
						</div>
						<div class="form-group">
							<label>Nội dung:</label>
							<input type="text" class="form-control" height="200px" required
								id="t_trichdoan" name="noidung" placeholder="Nhập vào nội dung">
						</div>
						<button class="btn btn-info" type="submit" name="themtb"
							id="btnShowModal_themtb">Thêm thông báo</button>
					</form>
				</div>
			</div>
		</div>
