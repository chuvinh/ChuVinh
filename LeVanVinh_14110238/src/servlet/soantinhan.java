...
/**
 * Servlet implementation class soantinhan
 */
@WebServlet("/soantinhan")
public class soantinhan extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("guitn")!=null){
			...
			tn.setTieude(tieude);
			tn.guitn();
			out.print("<script>window.location.href='selecttinnhan?mssv="+manhan+"';</script>");
		}
	}
